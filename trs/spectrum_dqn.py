...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="mpar_sim/DiscreteSpectrumEnv",
...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        if capture_video and idx == 0:
            env = gym.make(env_id, max_episode_steps=256, render_mode="rgb_array", seed=seed+idx, **ENV_KWARGS)
