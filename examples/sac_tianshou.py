...
train_envs = DummyVectorEnv([lambda: make_env(env_id, i) for i in range(args.training_num)])
test_envs = DummyVectorEnv([lambda: make_env(env_id, i) for i in range(args.test_num)])
